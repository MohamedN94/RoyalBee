...
class Products extends Component
{
    ...
    {
        $this->products = Product::select(['id', 'name_ar', 'name_en', 'description_ar', 'description_en', 'slug', 'image', 'price', 'discount_price', 'review', 'best_seller'])
    ...
    {
        $cart = Cart::content();
        return view('livewire.products', compact('cart'));
    }
