...
//grid layout view
    ...
    $(document).ready(function () {
        ...
        $("body").on("click", ".theme-layout-version", function () {
            $(this).toggleClass('dark');
            $('body').removeClass('dark');

            if ($('.theme-layout-version').hasClass('dark')) {
                // Set dark theme and save preference to localStorage
                $('.theme-layout-version').text('Light');
                $('body').addClass('dark');
                localStorage.setItem('theme', 'dark');
            } else {
                // Set light theme and save preference to localStorage
                $('#theme-dark').remove();
                $('.theme-layout-version').text('Dark');
