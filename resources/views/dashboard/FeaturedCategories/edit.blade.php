            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    <li class="breadcrumb-item">
                        <a href="{{route('dashboard.featured_categories.edit',['featured_category'=>$featuredCategory->id])}}"
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-custom gutter-b ">
                        ...
                        <form action="{{ route('dashboard.featured_categories.update', ['featured_category' => $featuredCategory->id]) }}"
                              method="POST"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title_ar"
                                                   value="{{ $featuredCategory->title_ar ?? old('title_ar') }}"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title_en"
                                                   value="{{ $featuredCategory->title_en ?? old('title_en') }}"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="link"
                                                   value="{{ $featuredCategory->link ?? old('link') }}"
                                    ...
                                    <div class="col-sm-3 col-12 form-group m-form__group">
                                        <img style="width: 100%" src="{{ asset($featuredCategory->image) }}"/>
                                    </div>
