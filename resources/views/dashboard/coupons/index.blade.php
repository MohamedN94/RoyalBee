            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    <li class="breadcrumb-item">
                        <a href="{{ route('dashboard.coupons.index') }}" class="text-muted">{{ __('dashboard.list') }}</a>
                    </li>
                </ul>
            </div>
            <!--end::Info-->
                    ...
                    <table class="table table-bordered responsive" id="kt_datatable">
                        <thead>
                            <tr>
                                ...
                                <th>{{ __('dashboard.discount_code') }}</th>
...
@section('scripts')
    ...
    <script>
        ...
        var table1 = $('#kt_datatable').DataTable({
            ...
            ajax: {
                url: '{{ route('dashboard.coupons.show') }}',
                data: function(d) {
                    d.id = $('#id').val();
                    d.code = $('#code').val();
            ...
            columns: [
                ...
                {data: 'discount', name: 'discount', defaultContent: '-'},
