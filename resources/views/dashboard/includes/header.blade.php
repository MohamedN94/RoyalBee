            ...
            <div class="dropdown">
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                    <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
                        <img class="h-20px w-20px rounded-sm"
                             src="{{App::getLocale()=='ar'?asset('assets/media/svg/flags/133-saudi-arabia.svg'):asset('assets/media/svg/flags/226-united-states.svg')}}"
                             alt=""/>
                    </div>
                </div>
                <!--end::Toggle-->
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
                    ...
                    <ul class="navi navi-hover py-4">
                        <!--begin::Item-->
                        <li class="navi-item @if(App::getLocale()=='en') active @endif">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="navi-item @if(App::getLocale()=='ar') active @endif">
