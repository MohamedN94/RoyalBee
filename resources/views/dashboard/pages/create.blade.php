                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>{{ __('dashboard.pages') }} <span
                                                    class="text-danger">*</span></label>
                                            <select name="page_type_id"
                                                    class="form-control {{ $errors->has('page_type_id') ? 'is-invalid' : '' }}"
                                                    placeholder="{{ __('dashboard.enter') . ' ' . __('dashboard.pages') }}">
                                                <option selected disabled>{{ __('dashboard.choose-page-type') }}</option>
                                                @foreach($pageTypes as $pageType)
                                                    ...
                                                    @endphp
                                                    <option
                                                        value="{{ $pageType->id }}" {{ old('page_type_id', $selectedPageTypeId ?? '') == $pageType->id ? 'selected' : '' }}>
