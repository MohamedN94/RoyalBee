    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">{{ __('dashboard.payments') }}</h5>
                <!--end::Page Title-->
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    <li class="breadcrumb-item">
                        <a href="{{ route('dashboard.payments.index') }}"
                           class="text-muted">{{ __('dashboard.list') }}</a>
                    </li>
                </ul>
            </div>
            <!--end::Info-->
...
@section('content')
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-3">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <a href="{{ route('dashboard.payments.create') }}" class="btn btn-primary font-weight-bolder">
    ...
    @include('dashboard.includes.delete-modal', ['action_message' => __('dashboard.this_product')])
@endsection
@section('scripts')
    ...
    <script>
        ...
        var table1 = $('#kt_datatable').DataTable({
            ...
            ajax: {
                url: '{{ route('dashboard.payments.show') }}',
                data: function (d) {
                    d.id = $('#id').val();
            ...
            columns: [
                ...
                // {data: 'emirate', name: 'emirate', defaultContent: '-'},
                // {data: 'street_address', name: 'street_address', defaultContent: '-'},
                ...
                {data: 'products', name: 'products', defaultContent: '-'},
