            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-custom gutter-b ">
                        <!--begin::Form-->
                        <form action="{{route('dashboard.Reels.update',['Reel'=>$Reel->id])}}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name_ar" value="{{$Reel->name_ar??old('name_ar')}}"
                                        ...
                                        <div class="form-group">
                                            <label>{{ __('dashboard.name_en') }}
                                                <span class="text-danger">*</span></label>
                                            <input type="text" name="name_en" value="{{$Reel->name_en??old('name_en')}}"
                                        ...
                                        <div class="form-group">
                                            <label>{{ __('dashboard.link') }}
                                                <span class="text-danger">*</span></label>
                                            <input type="text" name="video" value="{{$Reel->video??old('video')}}"
