            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    <li class="breadcrumb-item">
                        <a href="{{route('dashboard.Services.edit',['Service'=>$Service->id])}}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title_ar" value="{{$Service->title_ar??old('title_ar')}}"
                                        ...
                                        <div class="form-group">
                                            <label>{{ __('dashboard.title_en') }}
                                                <span class="text-danger">*</span></label>
                                            <input type="text" name="title_en" value="{{$Service->title_en??old('title_en')}}"
                                        ...
                                        <div class="form-group">
                                            <label>{{ __('dashboard.short_description_ar') }}
                                                <span class="text-danger">*</span></label>
                                            <input type="text" name="short_description_ar" value="{{ $Service->short_description_ar??old('short_description_ar') }}"
                                        ...
                                        <div class="form-group">
                                            <label>{{ __('dashboard.short_description_en') }}
                                                <span class="text-danger">*</span></label>
                                            <input type="text" name="short_description_en" value="{{ $Service->short_description_en??old('short_description_en') }}"
                                            ...
                                            <div class="form-group">
                                                <label>{{ __('dashboard.description_ar') }}
                                                    ...
                                                    <textarea id="description" name="description_ar" id="" cols="30" rows="10"
                                                        ...
                                                        placeholder="{{ __('dashboard.enter') . ' ' . __('dashboard.description_ar') }}">{{$Service->description_ar}}</textarea>
                                                <span
                                            ...
                                            <div class="form-group">
                                                <label>{{ __('dashboard.description_en') }}
                                                    ...
                                                    <textarea id="description2" name="description_en" id="" cols="30" rows="10"
                                                        ...
                                                        placeholder="{{ __('dashboard.enter') . ' ' . __('dashboard.description_en') }}">{{$Service->description_en}}</textarea>
                                                <span
                                            ...
                                            <select name="category_id" id="categoryDropdown"
                                                ...
                                                @forelse ($categories as $value)
                                                    <option value="{{ $value->id }}"
                                                        {{ $Service->category_id == $value->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-sm-3 col-12 form-group m-form__group">
                                        <img style="width: 100%" src="{{ asset($Service->image) }}" />
                                    </div>
                                    <div class="col-sm-6 col-12 form-group m-form__group">
                                    ...
                                    <div class="col-sm-3 col-12 form-group m-form__group">
                                        <img style="width: 100%" src="{{ asset($Service->icon) }}" />
                                    </div>
                                    {{-- -------------------------------- --}}
                                    ...
                                    <div class="col-md-12 form-group m-form__group">
                                        ...
                                        <div class="form-group">
                                            <label>{{ __('dashboard.meta_title') }}
                                                <span class="text-danger">*</span></label>
                                            <input type="text" name="meta_title"  value="{{ $Service->meta_title??old('meta_title') }}"
                                            ...
                                            <div class="form-group">
                                                <label>{{ __('dashboard.meta_description') }}
                                                    ...
                                                    <textarea id="description" name="meta_description" id="" cols="30" rows="10"
                                                        ...
                                                        placeholder="{{ __('dashboard.enter') . ' ' . __('dashboard.meta_description') }}">{{$Service->meta_description}}</textarea>
                                                <span
                                        ...
                                        <div class="form-group">
                                            <label>{{ __('dashboard.meta_canonical') }}
                                                <span class="text-danger">*</span></label>
                                            <input type="text" name="meta_canonical"  value="{{ $Service->meta_canonical??old('meta_canonical') }}"
                                        ...
                                        <div class="form-group">
                                            <label>{{ __('dashboard.meta_opengraph') }}
                                                <span class="text-danger">*</span></label>
                                            <input type="text" name="meta_opengraph"  value="{{ $Service->meta_opengraph??old('meta_opengraph') }}"
                                        ...
                                        <div class="form-group">
                                            <label>{{ __('dashboard.meta_property') }}
                                                <span class="text-danger">*</span></label>
                                            <input type="text" name="meta_property"  value="{{ $Service->meta_property??old('meta_property') }}"
                                        ...
                                        <div class="form-group">
                                            <label>{{ __('dashboard.meta_twitter') }}
                                                <span class="text-danger">*</span></label>
                                            <input type="text" name="meta_twitter"  value="{{ $Service->meta_twitter??old('meta_twitter') }}"
                                        ...
                                        <div class="col-sm-3 col-12 form-group m-form__group">
                                            <img style="width: 100%" src="{{ asset($Service->meta_jsonLd) }}" />
                                        </div>

                                        <div class="form-group">
                                            <label>{{ __('dashboard.meta_Keyword') }}
                                                <span class="text-danger">*</span></label>
                                            <input type="text" name="meta_Keyword"  value="{{ $Service->meta_Keyword??old('meta_Keyword') }}"
