...
<script>
    ...
    })(window, document, 'script', 'dataLayer', 'GTM-NNZ78GXF');

</script>
<!-- End Google Tag Manager -->
<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NNZ78GXF"
...
<!-- TikTok Pixel Code End -->
 <script>
    ...
    @if(isset($values) && isset($content_ids) && isset($content_names) && isset($quantities))
        window.dataLayer.push({
            'event': 'initiateCheckout',
            'currencyCode': 'AED',
            'conversionValue': {{ array_sum($values) }},
            'transactionID': '{{ uniqid() }}',
            'contentIDs': @json($content_ids),
            'contentNames': @json($content_names),
            'numItems': {{ array_sum($quantities) }}
        });
    @endif
</script>
<script>
  ...
  window.dataLayer.push({
      event: "chekout",
      ecommerce: {
            transaction_id: "{{ $payment->transaction_id }}", // Unique transaction ID
            amount: "{{ $payment->amount }}", // Unique transaction ID
            @if($payment->amount < 500)
            adjusted_amount: {{ $payment->amount - 25 }}, // Deduct 25 AED if amount is less than 500
            @endif

            items: [
                @foreach($payment->products as $product)
                {
                    item_name: "{{ $product->name_en }}", // Product name
...
<script>
  gtag('event', 'page_view', {
    page_title: 'Home',
    page_location: 'https://royalbee.ae/',
    page_path: ''
  });
</script>
    <!-- Bootstrap CSS for centering -->
...
<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NNFJTP2N"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<!-- End Google Tag Manager (noscript) -->
<!-- loader start -->
                        ...
                        <div class="menu-block">
                            <nav id="main-nav">
                                ...
                                <ul id="main-menu" class="sm pixelstrap sm-horizontal">
                                    ...
                                    <!--<li>-->
                                    <!--    <a class="dark-menu-item" href="{{route('web.blogs.index')}}">{{__('Blog')}}</a>-->
                                    <!--</li>-->
                                    <li>
                                    ...
                                    <li>
                                        <a class="dark-menu-item" href="https://royalbee.ae/category/dates-offers">{{__('dashboard.dates_offers')}}</a>
                                    </li>
                                    <li>
                                        <a class="dark-menu-item" href="https://royalbee.ae/category/summer-offers">{{__('dashboard.summer-offers')}}</a>
                                    </li>

                                    <li>
                                        <a class="dark-menu-item" href="https://royalbee.ae/category/offers">{{__('dashboard.offers')}}</a>
                                    </li>
                        ...
                        <div class="category-right">
                            <div class="contact-block">
                                <div>
                                    ...
                                    <span>{{__('call us')}}
                                        <span>
                                        <a style="color: white;" href="tel:971508841893"> 971508841893</a>
                                    </span>
                                </span>
                                </div>
                            </div>
                            <div class="btn-group">
                                <div class="gift-block" data-bs-toggle="dropdown">
                                        ...
                                        <div class="gift-offer">
                                            <a style="color: white;" href="https://royalbee.ae/category/offers">
                                                <p>{{__('gift_box')}}</p>
                                                <span>{{__('offer')}}</span>
                                            </a>
                                        </div>
