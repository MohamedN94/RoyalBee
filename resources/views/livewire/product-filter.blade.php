            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="filter-main-btn">
                        <span class="filter-btn"><i class="fa fa-filter" aria-hidden="true"></i> {{__('Filter')}}</span>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="product-filter-content" wire:ignore>
                            ...
                            <div class="product-imgbox">
                                <div x-data x-init="
                                    ...
                                    <a href="{{route('web.product.show',$product->slug)}}"><img
                                            ...
                                            alt="{{ app()->getLocale() == 'ar' ? $product->name_ar : $product->nme_en  }}"></a>
                                </div>
                            ...
                            <div class="product-detail detail-center detail-inverse text-center">
                                <div class="detail-title">
                                    <div class="detail-left">
                                        ...
                                        <p>{{ app()->getLocale() == 'ar' ? $product->name_ar : $product->nme_en  }}</p>
                                        <a href="{{route('web.product.show',$product->slug)}}">
                                            <h6 class="price-title">{{ app()->getLocale() == 'ar' ? $product->name_ar : $product->nme_en }}</h6>
                                        </a>
                                    </div>
